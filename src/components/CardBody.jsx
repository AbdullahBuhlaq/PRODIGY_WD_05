  ...
  return (
    <div className="card-body">
      ...
      <div className="daily-container">
        ...
        <div className="d-flex justify-content-center daily-title current-title">
          Daily Calendar
        </div>
        <img
          src="./spring.png"
          alt=""
          className="d-flex justify-content-center daily-title current-title daily-img"
        />
        <button
